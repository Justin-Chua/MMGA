<script setup>
    ...
    const fetchUserInfo = async () => {
        const response = await fetch('https://mmga-production.up.railway.app/viewProfile/', {
            method: 'POST',
            headers: {
    ...
    const fetchTopGames = async() => {
        const response = await fetch('https://mmga-production.up.railway.app/user/topGames?username='+profileUsername.value);
