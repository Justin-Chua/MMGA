...
<script>
    ...
    export default {
        ...
        mounted() {
            fetch("mmga-production.up.railway.app/discussion/getDiscussionAndPosterById?id=" +  this.$route.params.discussionId, {method: "GET"})
            .then(res => res.json())
            .then(data => {
        ...
        methods: {
            ...
            submitNewComment: async function(){
                ...
                console.log(body)
                const response = await fetch('mmga-production.up.railway.app/discussion/addDiscussionResponse', {method: 'POST', headers: {"Access-Control-Allow-Origin" : "*",
