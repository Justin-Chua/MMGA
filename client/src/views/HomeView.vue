<script setup>
  ...
  const fetchNewsData = async () => {
    const response = await fetch('mmga-production.up.railway.app/homeDashboard');
    const data = await response.json();
    newsData.value = data;
  };

  const fetchTrendingGame = async () => {
    const response = await fetch('mmga-production.up.railway.app/game/trendingGame');
    const data = await response.json();
    trendingGame.value = await data;
  }

  const fetchTrendingDiscussions = async() => {
    const response = await fetch('mmga-production.up.railway.app/discussion/trendingDiscussions');
    const data = await response.json();
